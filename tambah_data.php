        ...
        <div class="col-md-8 col-xs-8" id="content-customer-body">
          <div class="box">
              <div class="box-header with-border" id="load-data">
                <h3 class="box-title">Add Data Complaint</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                   ...
                   <!-- Form Input Data-->
                    <form action="proses_data.php" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="15" name="isi_pengaduan"></textarea>
                      </div>
                      <div class="form-group">
                        <label>Choose Disposition:</label>
                      ...
                      <button name="submit" type="submit" class="btn btn-primary" value="Tambah">Add</button>&nbsp;
                    </form>
