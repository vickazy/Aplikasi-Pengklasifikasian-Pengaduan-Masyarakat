        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle">
              <span class="logo-lg" style="font-style: italic;"><b>APLICATION OF SOCIETY'S COMPLAINT CLASSIFICATION BANDUNG</b></span>
            </a>
          </li>
        </ul>
      </div>
              ...
              <div class="box-body">
                <table class="table table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody id="list-data">
                   <?php 
                      include("koneksi.php");
                      $query=mysql_query("select * from basic_word") or die(mysql_error());
                      while($row=mysql_fetch_array($query))
                      {
                      ?>
                      <tr>
                        <td><?php echo $row['id']?></td>
                        <td><?php echo $row['basic_word']?></td>
                        <td><?php echo $row['type_basic_word']?></td>
                      </tr>
                      <?php 
                      } 
                    ?>
