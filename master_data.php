    ...
    <div class="row" id="content-customer">
  	  <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <a style="color: black" href="dokumen.php">
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">&nbsp;</span>
              <a style="color: black" href="nilai_index.php">
              <span class="info-box-number">
                Weight Value
              </span>
              </a>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box">
            <span class="info-box-icon bg-orange"><i class="fa fa-text-width"></i></span>
            <div class="info-box-content">
              <span class="info-box-text">&nbsp;</span>
              <a style="color: black" href="kata_dasar.php">
              <span class="info-box-number">
                Basic Word Collection
              </span>
              </a>
            </div>
          </div>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">&nbsp;</span>
              <a style="color: black" href="nama_disposisi.php">
              <span class="info-box-number">
                Disposition List
              </span>
              </a>
