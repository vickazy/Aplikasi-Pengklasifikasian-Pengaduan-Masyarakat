  ...
  <div class="content-wrapper">
	  ...
	  <div class="col-md-12 col-xs-12" id="content-customer-body">
	    <div class="box" style="text-align: center;">
            ...
            <img src="assets/images/logo.png" alt="logo"  width="170" >
	          <h3>Welcome to the Application of Bandung City Citizens’ Complaint Classification</h3>
	        </div>
	        <!-- /.box-header -->
	        <div>
	          <h4>This application is used to classify the data complaints of Bandung city to know automatically where the data will be disposed</h4>
	        </div>
	        <!-- /.box-body -->
    ...
    <div class="row">
      <div class="col-lg-4 col-xs-4">
        ...
        $query = mysql_query("SELECT doc_id FROM documents");
        $jumlah = mysql_num_rows($query);
        $number_format = number_format($jumlah);
        ?>
        <div class="small-box bg" style="background:#0097e6; color: white">
          <div class="inner">
            <h3><?php echo "$number_format"; ?></h3>
            <p>Data Training</p>
          </div>
          <div class="icon">
            <i class="ion ion-bag"></i>
          </div>
          <a href="dokumen.php" class="small-box-footer">Show Detail  <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div><!-- ./col -->
      <div class="col-lg-4 col-xs-4">
        <!-- small box -->
        ...
        $query = mysql_query("SELECT id FROM stemming");
        $jumlah = mysql_num_rows($query);
        $number_format = number_format($jumlah);
        ?>
        <div class="small-box bg" style="background: #228B22; color: white">
          <div class="inner">
            <h3><?php echo "$number_format"; ?></h3>
            <p>Token</p>
          </div>
          ...
          <a href="token.php" class="small-box-footer">Show Detail   <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div><!-- ./col -->
      <div class="col-lg-4 col-xs-4">
        <!-- small box -->
        ...
        $query = mysql_query("SELECT code_disposition FROM disposition");
        $jumlah = mysql_num_rows($query);
        $number_format = number_format($jumlah);
        ?>
        <div class="small-box bg" style="background: #FFD700; color: white">
          <div class="inner">
            <h3><?php echo "$number_format"; ?></h3>
            <p>Disposition</p>
          </div>
          ...
          <a href="nama_disposisi.php" class="small-box-footer">Show Detail  <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div><!-- ./col -->
    </div><!-- /.row -->
