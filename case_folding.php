              ...
              <div class="box-body">
                <table class="table table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody id="list-data">
                   <?php 
                      include("koneksi.php");
                      $query=mysql_query("SELECT case_folding.`doc_id`, case_folding.`case_folding`, disposition.`name_disposition` FROM case_folding INNER JOIN disposition ON case_folding.`code_disposition` = disposition.`code_disposition`;") or die(mysql_error());
